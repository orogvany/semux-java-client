...
public class Hex
{
     ...
     *
     * @param hex
     * @throws SemuxException
     *             if the input is not a valid hex string
     * @return
     */
    public static byte[] decode(String hex) throws SemuxException
    {
        if (hex == null || !hex.matches("([0-9a-fA-F]{2})*"))
        {
            throw new SemuxException("Invalid hex string");
        }
     ...
     *
     * @param hex
     * @throws com.semuxpool.client.api.SemuxException
     *             if the input is not a valid hex string
     * @return
     */
    public static byte[] decode0x(String hex) throws SemuxException
    {
